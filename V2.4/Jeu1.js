...
devinette.addEventListener("click", function () {
    ...
    .then(result => {
        ...
        if (result.includes("Yes")) {
            ...
            setTimeout(() => {
                ...
                document.body.innerHTML = "<h1 style='font-size: 80px; text-align: center; color: red;'>💥 BRAVO 💥</h1>";
            }, 1000);
    ...
    .catch(err => {
        console.error("Erreur lors de la requête deviner.php :", err);
    });
});
...
form.addEventListener("submit", function (e) {
    ...
    fetch("handler_chatbox_user1.php", {
        method: "POST",
        body: formData
    })
    .then(response => response.text())
